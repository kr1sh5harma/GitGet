    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-5 pt-24 pb-20">
        ...
        <div className="mb-10">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center gap-2 mb-2">
                <Link
                  ...
                  className="text-zinc-500 text-sm font-mono hover:text-zinc-300 transition-colors"
                >
                  {params.username}
                </Link>
                <span className="text-zinc-700">/</span>
                <h1 className="text-lg font-medium font-mono">{repo.name}</h1>
                {repo.fork && (
                  <span className="text-[10px] font-mono text-zinc-600 border border-[#2a2a2a] rounded px-1.5 py-0.5">fork</span>
                )}
                <span
              ...
              {repo.description && (
                <p className="text-[14px] text-zinc-400 leading-relaxed max-w-2xl">{repo.description}</p>
              )}
            </div>
            <a
              href={repo.html_url}
              ...
              className="text-xs font-mono text-zinc-500 border border-[#2a2a2a] px-4 py-2 rounded-lg hover:text-white hover:border-[#444] transition-all shrink-0 flex items-center gap-2"
            >
          ...
          {/* Quick info strip */}
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-xs font-mono text-zinc-600 mb-6">
            {primaryLang && (
          ...
          <div className="flex gap-3 flex-wrap">
            {[
              ...
              <div key={s.label} className="flex items-center gap-2 bg-[#111] border border-[#1e1e1e] rounded-lg px-3 py-2">
