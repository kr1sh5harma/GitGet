    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="mb-4">
            <p className="text-sm text-zinc-400 mb-3 font-mono">{health.reason}</p>
          ...
          {health.recommendations.length > 0 && (
            <div className="mb-4 pt-3 border-t border-[#1e1e1e]">
              <p className="text-xs text-zinc-500 font-mono mb-2 uppercase">What's left to improve:</p>
              <div className="space-y-1.5">
          ...
          {prs.length === 0 ? (
            ...
            <div className="space-y-5">
              ...
              <div className="text-xs text-zinc-600 font-mono">
                Total: <span className="text-zinc-400">{prs.length} pull requests</span>
              </div>
            </div>
          )}
        </motion.div>
